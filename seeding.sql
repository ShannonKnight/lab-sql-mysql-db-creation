INSERT INTO cars (carID, VIN, manufacturer, model, model_year, colour)
VALUES 	
...
INSERT INTO salesperson (salespersonID, staffID, staffname, store)
VALUES 
...
INSERT INTO customers (custID,customerID,cust_name,phone,email,address,city,state_province,country,zip_postcode)
VALUES 
...
INSERT INTO invoice (invid,invoice_no,dateofsale,carID,custID,salespersonID)
VALUES 
	(1, 852399038, '2018-08-22', 1, 1, 3),
	(2, 731166526, '2018-12-31', 3, 3, 5),
	(3, 271135104, '2019-01-22', 2, 2, 7);
    
INSERT INTO stores (storeid,storename,storeaddress)
VALUES
	(1,'Madrid','6 Madrid Ave'),
    (2,'Paris','78 Paris Str'),
